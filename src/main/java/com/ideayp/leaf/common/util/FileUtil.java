...
public class FileUtil {
    ...
    public static File[] listAll(File file) {
        ...
        list(list, file, new AcceptAllFileFilter());
        list.remove(file);
    ...
    // *****************************************
    protected static class AcceptAllFileFilter extends FileFilter {
  ...
  public static String getDocName(String urlpath) {
    try{
        URL url = new URL(urlpath);
        String path = url.getPath();
        String[] str = path.split("/");
        String docName = str[str.length - 1];
        return docName;
    }catch (Exception e){
        e.printStackTrace();
        return null;
    ...
    public static final boolean pathValidate(String path) {
        ...
        String tmpPath = "";
        for (String anArraPpath : arrayPath) {
            tmpPath += "/" + anArraPpath;
    ...
    public static boolean genModuleTpl(String path, String moduleContent) throws IOException {
        ...
        for (int i = 0; i < pathArray.length - 1; i++) {
            modulePath = modulePath + ("/" + pathArray[i]);
        }
